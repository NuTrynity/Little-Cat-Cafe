...
func sort_dist_to_player(area1, area2):
	var area1_to_player = player.global_position.distance_to(area1.globa_position)
	var area2_to_player = player.global_position.distance_to(area2.globa_position)
